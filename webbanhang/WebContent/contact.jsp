...
<!-- Mirrored from wow-themes.com/demo/html/perfume/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Aug 2015 06:50:56 GMT -->
<head>
  <meta charset="utf-8">
            ...
            <div class="col-sm-7 col-lg-8">
              <div class="form-section-box">
                ...
                <form class="checkout-form" method="post" action="#">
                  ...
                  <p class="text-center"><input type="submit" class="btn btn-default btn-lg" value="Send"></p>
